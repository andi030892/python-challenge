...
import csv
csvpath = os.path.join(r"C:/Users/aMysllinj/Desktop/python-challenge/PyPoll/Recources/election_data.csv")
...
with open(csvpath) as csvfile:
    ...
    with open(r"C:/Users/aMysllinj/Desktop/python-challenge/PyPoll/Analysis/Pypoll.txt", 'w') as file_PythonChallenge:
